...
const Cards: React.FC<CardsProps> = ({ track, button, token }) => {
  return (
    <div className="w-full hover:bg-neutral-700 flex group rounded-md items-center">
      <a href={"https://open.spotify.com/track/" + track.id} target="#" className="md:flex hidden text-neutral-900 group-hover:text-white pl-3">
        <BsPlayFill size={30}/>
      </a>
      <a className="w-full"  href={"https://open.spotify.com/track/" + track.id} target="#" >
